...
public class HiddenSingle {
	...
	public boolean found, in_row, in_column, in_block;
	public int row;
	public int column;
	public int digit;
	...
	public void setHidden_Single(String place, int row, int column, int number) {
	...
	public String info_place_Hidden_Single(int block_width, int block_height) {
